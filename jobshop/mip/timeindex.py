...
class TimeModel(JobShopModel):
    ...
    def _create_cstr(self):
        self.cstr_unique_start = pyo.Constraint(self.M, self.J, rule=self.rules.cstr_unique_start)
        self.cstr_unique_machine = pyo.Constraint(self.M, self.T, rule=self.rules.cstr_unique_machine)
        self.cstr_precede = pyo.Constraint(self.M, self.J, rule=self.rules.cstr_precede)
