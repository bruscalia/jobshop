...
class DisjModel(JobShopModel):
    ...
    def _create_cstr(self):
        self.cstr_seq = pyo.Constraint(self.M, self.J, rule=self.rules.cstr_seq)
        self.cstr_total_time = pyo.Constraint(self.J, rule=self.rules.cstr_total_time)
        self.cstr_precede = pyo.Constraint(self.M, self.J, self.J, rule=self.rules.cstr_precede)
        self.cstr_comp_precede = pyo.Constraint(self.M, self.J, self.J, rule=self.rules.cstr_comp_precede)
